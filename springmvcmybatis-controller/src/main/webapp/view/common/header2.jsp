...
<div class="navbarTop navbar-fixed-top clearfix fix-header">
    ...
    <ul class="navbar-nav toolbar pull-right" style="padding-top: 7px; padding-right: 18px;">
        ...
        <li class="text fix-manager"><a href="<%=request.getContextPath()%>/user/userInfo"><span></a>  <a href="/recharge/rechargeRecordManager">余额</span><span style="color:#f08200;"> </span>元</a> </li>
