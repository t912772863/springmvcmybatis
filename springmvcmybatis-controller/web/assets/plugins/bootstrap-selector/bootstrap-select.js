...
+function ($) {
    ...
    DropdownSelect.prototype.parts = function() {
        return {
            $select         : this.$element,
            $section        : this.options.inputname ||this.$element.attr('id'),
    ...
    DropdownSelect.prototype.defaults = function() {
        return {
            ...
            inputname   : this.$element.attr('data-inputname') || DropdownSelect.DEFAULTS.inputname,
    ...
    DropdownSelect.prototype.updateDisplay = function( mode, selected ) {
        if( mode == 'select') {
            ...
            this.$element.find('input[name="' + this.structure.$section + '"]').val( selected.data('value') );
        ...
        if( mode == 'clear') {
            ...
            this.$element.find('input[name="' + this.structure.$section + '"]').val('');
