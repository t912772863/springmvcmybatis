                ...
                <div class="fs14" style="border: none;">
                    <div class="recharge-title">
                        <ul class="list-inline text-left list-sort">
                            ...
                            <li class="active"><em></em><a href="/tableCategory/tableCategoryListView?storeId=${storeId}">餐桌分类管理</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="tableBox clearfix">
                <div class="tableOperating">
                    <div class="leftOperating">
                        <dl>
                            <dd>
                                <%--<a onclick="addConfigCount()" class="btn btn-default"><i class="fa fa-plus"></i> <span>新增</span></a>--%>
                            </dd>
                        </dl>
                        <span class="addBut btn btn-default" id="tableCategoryAddBut" data-toggle="modal" href="#tableCategoryDiv"><i class="fa fa-plus"></i>新增</span>
                    </div>
                    <%--查询条件--%>
                        ...
                        <div class="col-xs-4 col-sm-12 pdr0">
                            <div class="rightOperating" style="width: 50%;">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="searchInput" placeholder="餐桌类型名称">
                ...
                <!-- 新增操作层 s-->
                <c:import url="/WEB-INF/views/table/tableCategoryDlg.jsp"/>
                <!-- 新增层 e-->
                <div class="tableListBox tab-content clearfix" style="font-size: 14px;">
                    <table align="center" class="table table-hover table-striped table-bordered" id="tableCategoryTable"></table>
                </div>
                </div>
            </div>
        </div>
...
<script src="<%=request.getContextPath()%>/resources/js/table/storeTableCategoryList.js"></script>
</rapid:override>
